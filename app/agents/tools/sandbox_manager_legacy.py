"""HTTP client for jarvis-sandbox's own orchestrator — the "legacy" sandbox
backend (`SANDBOX_BACKEND=legacy`, the default). See `sandbox_manager.py` for
the dispatcher that picks between this and `sandbox_manager_agentsandbox.py`.
