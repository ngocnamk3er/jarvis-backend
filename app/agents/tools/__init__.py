...
tools = [bash, web_search, web_fetch, read_skill, represent_file, generate_visualization_mermaid, generate_visualization_svg, generate_animation, generate_webapp]
