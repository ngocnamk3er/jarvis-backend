...
tools = [get_current_time, calculator, run_python, web_search, create_file, represent_file, generate_visualization_mermaid, generate_visualization_svg, generate_animation]
